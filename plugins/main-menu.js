...
let knnt = `
Hai Kak Saya Elaina Botz, Asisten Kamu Yang Bisa Membantumu Seperti Membuat Sticker Dan Lainnya\n\nKata Kata Hari Ini : Jika rencananya tidak berhasil, ubahlah rencananya, tetapi jangan pernah ubah tujuannya.`
let ᴛᴇs = `Elaina-MD By Dims`
let wkwk = 'https://telegra.ph/file/c94f5045cb2943c5f9791.jpg'
...
async function genProfile(conn, m) {
  let font = await jimp.loadFont('./names.fnt'),
    ...
    avatar = await jimp.read(await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://telegra.ph/file/c94f5045cb2943c5f9791.jpg')),
