...
const sections = [
   {
    ...
    rows: [
        {title: `「ღ」Speed Bot`, rowId: ".speed", description: "Menampilkan kecepatan respon BOT"},
        {title: `「ღ」Owner Bot`, rowId: ".owner", description: "Menampilkan List owner BOT"},
        {title: `「ღ」Runtime Bot`, rowId: ".runtime", description: "𝙼𝚎𝚗𝚊𝚖𝚙𝚒𝚕𝚔𝚊𝚗 Waktu Bot Berjalan"}, 
        {title: `「ღ」Script Bot`, rowId: ".sc", description: `Source Code ${namebot}`},
    ]
      },{
        title: `${htki} Support ${htka}`,
        rows: [
            {title: `「ღ」Sewa`, rowId: ".sewa", description: "Menampilkan list harga sewa BOT"},
            {title: `「ღ」Buy Premium`, rowId: ".premium", description: "Menampilkan list harga premium"},
            {title: `「ღ」Donasi`, rowId: ".donasi", description: 'Support BOT agar lebih fast respon'},
            {title: `「ღ」Subscribe My Yt Cannel`, rowId: ".zykomd", description: 'Support DimsT coy'}
            ]
        },{
          title: `${htki} Store Menu ${htka}`,
          rows: [
            {title: `「ღ」Store`, rowId: ".? store", description: "Tempat Jualan Anak Jb"},           
        ]
        },{
          title: `${htki} Menu Menfess ${htka}`,
          rows: [
            {title: `「ღ」Menfess Balas`, rowId: ".? menbalas", description: "Menampilkan Semua command BOT"},
          ]},{
        title: `${htki} Main Menu ${htka}`,
        rows: [
        {title: `「ღ」All`, rowId: ".? all", description: "Menampilkan Semua command BOT"},
        {title: `「ღ」Rpg`, rowId: ".? rpg", description: "Game Epic Rpg!"},
        {title: `「ღ」Exp`, rowId: ".? xp", description: "Ayo tingkatkan pangkat mu!"},
        {title: `「ღ」Game`, rowId: ".? game", description: "Gamenya seru seru lho >-<"},
        {title: `「ღ」Fun`, rowId: ".? fun", description: "Fitur yang aman untuk keluarga"},
        {title: `「ღ」Kerang`, rowId: ".? kerangajaib", description: "Tanyakan pada ketua club"},
        {title: `「ღ」Quotes`, rowId: ".? quotes", description: "Random Inspirasi"},        
         {title: `「ღ」Asupan`, rowId: ".? asupan", description: "Menampilkan Asupan DiBot"},        
        {title: `「ღ」Anime`, rowId: ".? anime", description: "Kamu wibu ya bang?"},
        {title: `「ღ」Nsfw`, rowId: ".? nsfw", description: "Tch, dasar sagne"},
        {title: `「ღ」Premium`, rowId: ".? premium", description: "Only premium Users"},
        {title: `「ღ」Anonymous Chats`, rowId: ".? anonymous", description: "Bicara dengan orang tidak dikenal"},
        {title: `「ღ」Al-Quran`, rowId: ".? quran", description: "Tobat yuk kak"},
        {title: `「ღ」Internet`, rowId: ".? internet", description: "Cari sesuatu diBOT"},
        {title: `「ღ」Berita`, rowId: ".? berita", description: "Cari berita terupdate"},
        {title: `「ღ」Downloaders`, rowId: ".? downloader", description: "Download sesuatu diBOT"},
        {title: `「ღ」Stikers`, rowId: ".? stiker", description: "Buat Sticker diBOT"},
        {title: `「ღ」Logo`, rowId: ".? maker", description: "Buat Logo Kamu diBOT"},
        {title: `「ღ」Nulis`, rowId: ".? nulis", description: "Nulis kok males kak?"},
        {title: `「ღ」Buat Catatan`, rowId: ".? catatan", description: "Buat Catatan Kamu di Bot"},
        {title: `「ღ」Preset Alight Montion/Apk`, rowId: ".presetmenu", description: "Gunakan Preset Bot buat Alight Montion Mu"},                        
        {title: `「ღ」Audio Anime`, rowId: ".? audioanime", description: "Kamu Wibu ya Bang"},             
        {title: `「ღ」Audio`, rowId: ".? audio", description: "Ubah Audio dengan Filter"},
        {title: `「ღ」Sound Menu`, rowId: ".soundmenu", description: "Kumpulan 120 Sound"},
        {title: `「ღ」Group`, rowId: ".? group", description: "Only Groups"},
        {title: `「ღ」Admin`, rowId: ".? admin", description: "Only Admin Group"},
        {title: `「ღ」Database`, rowId: ".? database", description: "Simpan sesuatu diBOT"},
        {title: `「ღ」Tools`, rowId: ".? tools", description: "Mungkin tools ini bisa membantu?"},         
        {title: `「ღ」Info`, rowId: ".? info", description: "Info info BOT"},
        {title: `「ღ」Owner`, rowId: ".? owner", description: "Owner Only!"},
        {title: `「ღ」No Category`, rowId: ".? nocategory", description: "Fitur tanpa kategory!"},
   ]
}, {
title: `${htki} Main Menu Awal Yg Baru By: ${nameown1} ${htka}`,
rows: [
            {title: `「ღ」Menu V1`, rowId: ".menuv1", description: `Menampilkan Menu V1`},
            {title: `「ღ」Menu V2`, rowId: ".menuv2", description: `Menampilkan Menu V2}`},
            {title: `「ღ」Menu V3`, rowId: ".menuv3", description: `Menampilkan Menu V3`},
]}]                        
let tek = `
「 *U s e r  I n f o 克* 」
