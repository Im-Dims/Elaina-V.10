...
var handler = async (m, { conn, command, text, usedPrefix }) => {
  ...
  let captvid = `â•­â”€â”€â”€â”€ ã€” Y O U T U B E ã€•
â€¢ Judul: ${title}
...
â€¢ Link: ${url}
â•°â”€â”€â”€â”€â”€â”€â”€â”€â¬£`
  conn.sendButton(m.chat, `____Y O U T U B E ____
○ Judul: ${title}
...
○ Link: ${url}
___________________________________`, author.trim(), await( await conn.getFile(thumbnail)).data, ['Video', `${usedPrefix}ytv ${url}`], false, { quoted: m, 'document': { 'url':'https://wa.me/12522518391' },
